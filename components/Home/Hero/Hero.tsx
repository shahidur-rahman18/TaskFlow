  ...
  return (
    <div className="relative w-full h-[145vh] md:h-[120vh] lg:h-[160vh] items-center flex justify-center flex-col ">
      <div className=" relative">
        ...
        <div
          data-aos="zoom-in"
          className="w-36 h-36 rounded-full -top-16 -left-10 bg-yellow-300 absolute -z-10"
        ></div>
        {/* Heading   */}
        <h1
          data-aos="fade-up"
      ...
      <div
        data-aos="fade-up"
        data-aos-delay="300"
        className="h-20 rounded-full mt-8 md:px-4 w-[95%] md:w-1/2 lg:w-1/3 border-2 border-gray-300 flex items-center justify-between "
      >
        {/* input  */}
        <input
          type="text"
